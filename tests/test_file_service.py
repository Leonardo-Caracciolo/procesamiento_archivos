...
def test_save_to_excel_with_nonexistent_directory():
    ruta_excel = "L:\\Procesamiento_PDF\\procesamiento_archivos\\Data\\Inputs\\datos_combinados - copia.xlsx"
    parent_dir = os.path.dirname(ruta_excel)
